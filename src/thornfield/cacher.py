...
class Cacher:
    ...
    def cached(self, cache: Optional[Cache] = None, validator: Optional[Callable[[Any], bool]] = None):
        if callable(cache):
    ...
    def _get_key(cls,
        ...
        return tuple(arg_values[a] if a in arg_values else defaults[a] for a in key_args)
